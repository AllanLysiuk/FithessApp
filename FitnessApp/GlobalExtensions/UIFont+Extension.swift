...
extension UIFont {
    ...
    static let mSemiBold14 = UIFont(name: "Montserrat-SemiBold", size: 14)
    ...
    static let mSemiBold30 = UIFont(name: "Montserrat-SemiBold", size: 30)
    
    static let mSemiBold32 = UIFont(name: "Montserrat-SemiBold", size: 32)
